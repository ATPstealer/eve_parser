        ...
        if liquidity_to.day_turnover >= day_turnover_threshold and liquidity_from.day_turnover >= day_turnover_threshold:
            ...
            if len(log) < 1:
                logistics_planning = LogisticsPlanning.objects.create(
                    ...
                    profit_from=(liquidity_from.price - liquidity_to.price)*(-1)*liquidity_from.day_volume,
                    profit_to=(liquidity_from.price - liquidity_to.price)*liquidity_to.day_volume)
